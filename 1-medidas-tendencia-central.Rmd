...
author:
    name: "[Carlos Daniel Olivares Reyes](https://c4rlosdanielolivares.github.io)"
...
> En el ámbito de la [estadística](https://es.wikipedia.org/wiki/Estad%C3%ADstica "Estadística"), la **mediana** (del latín *mediānus* 'del medio'^[1](https://es.wikipedia.org/wiki/Mediana_(estad%C3%ADstica)#cite_note-1)^​) representa el valor de la variable de posición central en un conjunto de datos ordenados.
